...
export type TierKey =
  | "wall_u45" | "wall_45" | "wall_45_65" | "wall_65_70" | "wall_100_140" | "wall_140"
  | "wall_unknown"
  | "car"
  | "desk_lo" | "desk_hi"
  | "wireless"
...
export const CHARGER_TIERS: Tier[] = [
  ...
  { key: "wall_u45",     label: "Wall <45W",       sub: "Phone / tablet" },
  { key: "wall_45",      label: "Wall 45W",        sub: "The 45W class" },
...
export function tierOf(name: string | null | undefined, power: string | null | undefined): TierKey {
  ...
  //    the standard ratings the category is sold on (45 / 65 / 100 / 140) — the
  //    exact ratings get their own band because that is how buyers shop them — so
  //    they are narrow and unevenly spaced rather than regular:
  //      <45 · =45 · 45<x<65 · 65≤x<100 · 100≤x<140 · ≥140
